...
const TermsAndConditions = () => {
    ...
    useEffect(() => {
        const loadPage = async () => {
            try {
                setLoading(true);
                // Using 'terms-conditions' as the slug
                const response = await fetchStaticPage('terms-conditions');
                if (response.success) {
        ...
        return (
            <div className="container mx-auto px-4 py-20 text-center">
                ...
                <p className="text-gray-500 mb-8">
                    {error ? 'Error loading terms and conditions.' : 'Terms and conditions content is currently being updated. Please check back later.'}
                </p>
